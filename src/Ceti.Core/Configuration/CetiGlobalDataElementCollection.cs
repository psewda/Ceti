...
{
    public class CetiGlobalDataElementCollection : ConfigurationElementCollection
    {
        ...
        {
            return elementName.Equals("Data", StringComparison.InvariantCultureIgnoreCase);
        }
        ...
        {
            return new CetiGlobalDataElement();
        }
        ...
        {
            return ((CetiGlobalDataElement)element).Name;
        }
