...
{
    public class CetiExecutionServiceProviderElementCollection : ConfigurationElementCollection
    {
        ...
        {
            return elementName.Equals("ExecutionServiceProvider", StringComparison.InvariantCultureIgnoreCase);
        }
        ...
        {
            return new CetiExecutionServiceProviderElement();
        }
        ...
        {
            return ((CetiExecutionServiceProviderElement)element).Name;
        }
